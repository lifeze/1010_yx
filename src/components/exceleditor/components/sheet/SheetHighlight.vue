...
export default {
    ...
    computed: {
        ...
        styles() {
            ...
            const h = getAreaCutLeftOrTope(
                this.$sheet.selectionCopy,
                this.info.top,
                this.info.height,
                this.$sheet.fixedHeight,
                this.$sheet.fixedRowIndex,
                this.$sheet.scrollTop,
                'rowIndex'
            );

            const w = getAreaCutLeftOrTope(
                this.$sheet.selectionCopy,
                this.info.left,
                this.info.width,
                this.$sheet.fixedWidth,
                this.$sheet.fixedColumnIndex,
